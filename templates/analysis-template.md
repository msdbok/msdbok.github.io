---
parent: [Section Name]  # Choose: People, Processes, Needs, Scope, Planning, Release, Tracking, Materials
title: [Comparative Analysis Title]
nav_order: [X]  # Check existing pages in your chosen section
layout: default
---
...
```mermaid
flowchart TD
    A[Start: Need to choose approach] --> B{Question 1?}
    B -->|Yes| C[Approach A]
    B -->|No| D{Question 2?}
    D -->|Yes| E[Approach B]
    D -->|No| F{Question 3?}
